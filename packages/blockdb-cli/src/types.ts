...
export interface FieldConfig {
   ...
   *
   * This is an **unchecked assertion**: blockdb stores and returns the payload verbatim and
...
export interface BlockDbConfig {
  ...
  /** Served data tree. Default `public/blockdb`. */
  output?: string;
  /** Generated client dir. Default `src/blockdb`. */
  clientOut?: string;
  /** Baked default for the generated `connect()`. Default `/blockdb`. */
  basePath?: string;
